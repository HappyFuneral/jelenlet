...
<x-app-layout>
    ...
    <div class="min-h-screen p-6 flex items-center justify-center">
        <form action="{{ route('attendanceModels.store') }}" method="POST" enctype="multipart/form-data" class="container max-w-screen-lg mx-auto">
            ...
            @method('POST')
            <div>
                <h2 class="font-semibold text-xl text-gray-600">Jelenlét hozzáadása</h2>
                    ...
                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                        ...
                        <div class="lg:col-span-2 mb-3">
                            ...
                            <div class="md:col-span-5">
                                ...
                                <input type="text" name="cause" id="docs" class="transition-all flex items-center h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="Miért kéne neked fizetnünk?">
                            </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                >Idő</label>
                                <div class="mt-2">
                                    <input datetimepicker id="exhibition_date" name="datetime" class="focus:shadow-soft-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none date-flatpickr" type="text" placeholder="Válassz időpontot" />
